...
if (-not $SkipDependencyInstall) {
    Invoke-Python -Command $PythonCmd -Arguments @(
        "-m", "pip", "install",
        "-r", "appDesktopV2/requirements-desktop.txt",
        "-r", "appDesktopV2/windows/requirements-build.txt"
    )
}

Invoke-Python -Command $PythonCmd -Arguments @("-m", "compileall", "appDesktopV2/roteirizador_desktop/ui.py")
Invoke-Python -Command $PythonCmd -Arguments @("appDesktopV2/windows/validate_layout_spec.py")
Invoke-Python -Command $PythonCmd -Arguments @(
    "-m", "PyInstaller",
    "--noconfirm",
    "--clean",
    "appDesktopV2/windows/roteirizador_desktop.spec"
)
