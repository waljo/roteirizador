...
from roteirizador_desktop.route_syntax import parse_route_text
...
def parse_fixed_route(route_str: str) -> Dict[str, Dict[str, int]]:
    ...
    Aceita a sintaxe legada e a nova sintaxe simplificada para drops
    explicitos, por exemplo ``-M9:2``.
    """
    deliveries = {}
    for part in parse_route_text(route_str):
        platform_norm = norm_plat(part.platform)
